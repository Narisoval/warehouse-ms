    ...
    private void SeedTestBrands()
    {
        Brands = new List<Brand>
        {
            Brand.Create(
                ...
                Image.From("https://img.favpng.com/10/3/23/happy-socks-men-s-cat-men-s-leopard-sock-s-socks-blue-pink-happy-socks-logo-png-favpng-NUf1FhWYaMTHq75Gf3LgJcXgp.jpg").Value,
            ...
            Brand.Create(
                ...
                Image.From("https://happydogclipsandkennels.files.wordpress.com/2019/08/happy-dog-country-clips-and-kennels-happy-dog-photos-1.png").Value,
                BrandDescription.From("These dogs are so happy and these creatures will make you as happy as they are!").Value).Value,
                
            Brand.Create(
                Guid.NewGuid(),
                BrandName.From("Happy Cocks").Value,
                Image.From("https://static.miraheze.org/avidwiki/thumb/7/7b/Happy_Cock_%281985%29_%28Credit_-_ifrequire%29.png/397px-Happy_Cock_%281985%29_%28Credit_-_ifrequire%29.png").Value,
    ...
    private void SeedTestProducts()
    {
        Products = new List<Product>
        {
            Product.Create(
                ...
                mainImage: Image.From("https://rainforestreports.weebly.com/uploads/1/5/5/7/15578800/9175403_orig.jpg").Value,
                images: new List<ProductImage>
                {
                    ProductImage.Create(Image.From("https://vignette.wikia.nocookie.net/naturerules1/images/b/b4/Capybara_nationalgeographic_1518115_2.ngsversion.1538507728041.adapt.1900.1.jpg").Value).Value,
                },
                productDescription: ProductDescription.From("100% cotton 1000% love. This socks will make you feel like no others").Value,
                isActive: true,
            ...
            Product.Create(
                ...
                mainImage: Image.From("https://cdn.shopify.com/s/files/1/0207/3802/products/cozy-socks-black-women.jpg").Value,
                images: new List<ProductImage>
                {
                    ProductImage.Create(Image.From("https://cdn.shopify.com/s/files/1/0207/3803/products/cozy-socks-black-women.jpg").Value).Value,
                    ProductImage.Create(Image.From("https://cdn.shopify.com/s/files/1/0207/3802/products/cozy-socks-black-women-1.jpg").Value).Value
                },
                productDescription: ProductDescription.From("These socks will keep your feet warm and comfortable during the cold winter nights").Value,
                isActive: true,
            ...
            Product.Create(
                ...
                mainImage: Image.From("https://gumlet.assettype.com/freepressjournal%2F2020-08%2F7bdd9149-37ea-4e9e-b1b8-0456f0d9d7bd%2F6132036Iq4DASOT.jpg").Value,
                images: new List<ProductImage>
                {
                    ProductImage.Create(Image.From("https://1721181113.rsc.cdn77.org/data/images/full/26936/stray-dogs.jpg").Value).Value,
                },
                productDescription: ProductDescription.From("This stray dog is probably the cutest thing you'll ever see in your life").Value,
                isActive: true,
            ...
            Product.Create(
                ...
                mainImage: Image.From("https://www.allfrbulldogs.com/wp-content/uploads/2021/03/How-to-Care-For-White-French-Bulldog.jpg").Value,
                images: new List<ProductImage>
                {
                    ProductImage.Create(Image.From("https://upload.wikimedia.org/wikipedia/commons/7/76/Altman_White_English_Bulldog.jpg").Value).Value,
                    ProductImage.Create(Image.From("https://www.publicdomainpictures.net/pictures/290000/velka/white-english-bulldog-portrait.jpg").Value).Value
                },
                productDescription: ProductDescription.From("This white bulldog will love you like your dad never did").Value,
                isActive: true,
                sale: Sale.From(15).Value,
                providerId: Providers[1].Id,
                brandId: Brands[1].Id,
            ...
            Product.Create(
                ...
                productDescription: ProductDescription.From("This beautiful male rooster has bright red feathers and a comb. It would make a great addition to any farm or backyard flock.").Value,
                isActive: true,
                sale: Sale.From(0).Value,
                providerId: Providers[1].Id,
                brandId: Brands[2].Id,
            ...
            Product.Create(
                ...
                productDescription: ProductDescription.From("This beautiful cock has vibrant green feathers and a proud stance. He would make a perfect addition to any farm or backyard flock.").Value,
                isActive: true,
                sale: Sale.From(10).Value,
                providerId: Providers[1].Id,
                brandId: Brands[2].Id,
